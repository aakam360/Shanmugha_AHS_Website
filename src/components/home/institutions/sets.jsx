    ...
    <>
      ...
      <Box sx={{ py: { xs: 5, md: 7 }, bgcolor: 'white' }}>
        <Container maxWidth="lg">
          ...
          >
            <Box component="img" src="/assets/images/batch-images/1.png" alt="Accreditation 1" sx={{ height: { xs: 110, md: 150 } }} />
            <Box component="img" src="/assets/images/batch-images/3.png" alt="Accreditation 2" sx={{ height: { xs: 110, md: 150 } }} />
            <Box component="img" src="/assets/images/batch-images/1.png" alt="Accreditation 3" sx={{ height: { xs: 110, md: 150 } }} />
          </Box>
          ...
          >
            Anna University | Nursing Council | M.G.R Medical University | Pharmacy Council Of India | ARIIA Innovation |
            Government Recognized | Industry Partnerships | International Standards
          </Typography>
        </Container>
      </Box>
      ...
      <Box sx={{ py: 1, bgcolor: '#f0f2f5' }}>
        <Container maxWidth="xl" >
          <Box sx={{ bgcolor: '#00205B', borderRadius: '25px', p: { xs: 2, md: 2 }, position: 'relative', color: 'white' }}>
            <Box
              component="img"
              src="/path/to/your/corner-logo.svg"
              alt=""
              sx={{ position: 'absolute', top: { xs: 20, md: 30 }, right: { xs: 20, md: 30 }, height: { xs: '25px', md: '35px' } }}
            />
            <Typography
              variant="h3"
              sx={{
...
<Box sx={{ mt: 3, bgcolor: 'white', borderRadius: '30px', p: 4 }}>
  {/* Top Row */}
  <LogoRow logos={topLogos} duration={40} />

  {/* Added spacing here */}
  <Box sx={{ height: { xs: 14, md: 10 } }} />  {/* This adds vertical space between the two rows */}
